...
export default async function TwitterImage({ params }: { params: Promise<{ tripId: string }> }) {
      ...
      >
        ...
        >
          <div style={{ display: "flex", gap: 40 }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontSize: 44, fontWeight: 700, color: "#2C2521" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <span style={{ fontSize: 28, fontWeight: 700, color: "#2C2521" }}>
              Stay
            </span>
          </div>
        </div>
