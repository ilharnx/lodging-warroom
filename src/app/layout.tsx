...
/**
 * BRAND META TAGS — DO NOT MODIFY without explicit request.
 * These are locked-down brand assets for stay.functionlabs.com.
 */
export const metadata: Metadata = {
  title: "Stay — Plan where to stay, together",
  description:
    "Compare vacation rental listings with your crew. Vote, comment, and narrow down the perfect place together.",
  metadataBase: new URL("https://stay.functionlabs.com"),
  openGraph: {
    title: "Stay — Plan where to stay, together",
    description:
      "Compare vacation rental listings with your crew. Vote, comment, and narrow down the perfect place together.",
    url: "https://stay.functionlabs.com",
    siteName: "Stay",
    images: [
      {
        url: "/og-image.png",
